            ...
            for key in data:
                ...
                for idx in range(0, int(data[key]["objects"]["num_obj"])):
                    ...
                    def get_class_index(cls_list, cls_hierarchy, cls_name):
                        ...
                        elif (cls_name == "TrafficLight_Red" or  cls_name == "TrafficLight_Yellow" or cls_name == "TrafficLight_Arrow" or cls_name == "TrafficLight_Green" or cls_name == "TrafficLight_RedArrow" or cls_name == "TrafficLight_YellowArrow" or cls_name == "TrafficLight_GreenArrow"):
                            cls_name = "TrafficLight"
                            return cls_list.index(cls_name)
                        elif (cls_name == "TrafficSign_Else" or  cls_name == "TrafficSign_Speed"):
                            cls_name = "TrafficSign"
                            return cls_list.index(cls_name)
        ...
        try:
            ...
            with open(os.path.abspath(manifest_abspath), "w") as manifest_file:
                ...
                for key in data:
                    ...
                    manifest_file.write(os.path.join(
                        "../coco/images/train2017", "".join([key, img_type, "\n"])))
            ...
            #print("error count : ", self.error_count) # my_code
